            ...
            <div class="row">
              <div class="col-lg-6">
                <h1 class="display-3  text-white">
                  This page is under construction and will be built soon.
            ...
            <div class="row row-grid">
              <div class="col-lg-4">
                <card class="border-0" hover shadow body-classes="py-5">
                  <img v-lazy="'img/i1.png'" class="card-img" />
                  <base-button
                    tag="a"
                    href="https://99designs.com/profiles/nowshadart/designs/1596610"
                    type="primary"
                    class="mt-4"
                  >
                    Learn more
              ...
              <div class="col-lg-4">
                <card class="border-0" hover shadow body-classes="py-5">
                  <img v-lazy="'img/i2.png'" class="card-img" />
                  <base-button
                    tag="a"
                    href="https://99designs.com/profiles/nowshadart/designs/1583069"
                    type="success"
                    class="mt-4"
                  >
                    Learn more
              ...
              <div class="col-lg-4">
                <card class="border-0" hover shadow body-classes="py-5">
                  <img v-lazy="'img/i3.png'" class="card-img" />
                  <base-button
                    tag="a"
                    href="https://99designs.com/profiles/nowshadart/designs/1582459"
                    type="warning"
                    class="mt-4"
                  >
                    Learn more
              ...
              <div class="col-lg-4">
                <card class="border-0" hover shadow body-classes="py-5">
                  <img v-lazy="'img/i4.png'" class="card-img" />
                  <base-button
                    tag="a"
                    href="https://99designs.com/profiles/nowshadart/designs/1582462"
                    type="primary"
                    class="mt-4"
                  >
                    Learn more
              ...
              <div class="col-lg-4">
                <card class="border-0" hover shadow body-classes="py-5">
                  <img v-lazy="'img/i5.png'" class="card-img" />
                  <base-button
                    tag="a"
                    href="https://99designs.com/profiles/nowshadart/designs/1413642"
                    type="success"
                    class="mt-4"
                  >
                    Learn more
              ...
              <div class="col-lg-4">
                <card class="border-0" hover shadow body-classes="py-5">
                  <img v-lazy="'img/i6.png'" class="card-img" />
                  <base-button
                    tag="a"
                    href="https://99designs.com/profiles/nowshadart/designs/1410670"
                    type="warning"
                    class="mt-4"
                  >
                    Learn more
